   ...
   if ( Estado != 1 ) {
      ...
      if (getprop("instrumentation/radar/selected")==2) {
         if (getprop("instrumentation/radar/range")==10) {
            ...
            setprop("instrumentation/radar/range-factor",0.00648);
         }
         elsif (getprop("instrumentation/radar/range")==20) {
            setprop("instrumentation/radar/range-factor",0.00324);
         }
         else { #40
            setprop("instrumentation/radar/range-factor",0.00162);
         }
      }
